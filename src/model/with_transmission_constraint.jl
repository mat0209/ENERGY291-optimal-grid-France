...
# Results
# =============================================================================
println("\n=== Optimal Capacity Expansion — With Limited Transmission ===")
...
output_path = joinpath(fig_dir, "capacity_results_limited_transmission.png")
savefig(output_path)
...
CSV.write(joinpath(DATA_results, "capacity_results_limited_transmission.csv"), results; delim=';')
println("Saved results to ", joinpath(DATA_results, "capacity_results_limited_transmission.csv"))
